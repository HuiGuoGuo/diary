...
ActiveRecord::Schema.define(:version => 20141117091243) do

  create_table "attachment_images", :force => true do |t|
  ...
  create_table "user_informations", :force => true do |t|
    ...
    t.string   "eamil"
    t.string   "address"
    t.string   "individuality_explanation"
    t.text     "introduce"
    t.datetime "created_at",                :null => false
    t.datetime "updated_at",                :null => false
  end
